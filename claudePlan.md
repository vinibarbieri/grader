...
Scaffold a Spring Boot 3 / Java 25 / Maven backend for the local grader platform as defined in `backend-prd.md` and `CLAUDE.md`. No existing backend code exists. The project will live at `grader/backend/`.
...
- `pom.xml`: Java 25, Spring Boot 3.x, spring-boot-starter-web, validation, Jackson, JUnit 5, Mockito
- `GraderApplication.java`
